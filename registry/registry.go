...
const (
	defaultPath    = "/_minirpc_/register"
	defaultTimeout = time.Minute * 5
)

func New(timeout time.Duration) *MiniRegister {
	return &MiniRegister{
...
var DefaultMiniRegister = New(defaultTimeout)
...
func HandleHTTP() {
	DefaultMiniRegister.HandleHTTP(defaultPath)
}
